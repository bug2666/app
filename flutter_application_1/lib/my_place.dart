...
class MyPlace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          block1(), // đặt tên cho các ô trong cột
          block2(),
          block3(),
          block4(),
        ],
...
Widget block1(){
  var src = 'https://images.unsplash.com/photo-1755899850036-084006cbc1c2?q=80&w=1144&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
